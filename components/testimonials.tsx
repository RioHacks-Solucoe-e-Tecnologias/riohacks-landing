...
import TestimonialImg09 from "@/public/images/testimonial-09.png";
import ClientImg01 from "@/public/images/logo-norteplay.png";
import ClientImg02 from "@/public/images/logo-alterdochaowine.png";
import ClientImg03 from "@/public/images/logo-drregulariza.png";
import ClientImg04 from "@/public/images/logo-dunortecred.png";
import ClientImg05 from "@/public/images/logo-lbin.png";
import ClientImg06 from "@/public/images/logo-serveapp.png";
import ClientImg07 from "@/public/images/logo-mirante.png";
import ClientImg08 from "@/public/images/logo-correria.png";
import ClientImg09 from "@/public/images/logo-gui360.png";
...
const testimonials = [
  {
    ...
    name: "Neto",
    company: "Norteplay",
    content: "A parceria com a Rio Hacks foi fundamental para transformar a ideia da Norteplay em realidade. Além de desenvolverem nosso app e site de divulgação com excelência, fomos contemplados com investimento no primeiro Hackatur, o que impulsionou nosso crescimento no cenário esportivo digital.",
    categories: [1, 2],
  },
  {
    ...
    name: "Samia L.",
    company: "Alter do Chão Wine",
    content: "A Rio Hacks conseguiu traduzir a essência do Alter do Chão Wine em nosso site e e-commerce. Foi incrível ver nossa proposta de unir sustentabilidade e tradição amazônica ganhar visibilidade no digital. Hoje conseguimos levar o primeiro vinho de açaí do mundo para ainda mais pessoas.",
    categories: [1, 3],
  },
  {
    ...
    name: "Celane S.",
    company: "Dr Regulariza",
    content: "A Rio Hacks foi além de desenvolver nosso site e sistema de Dashboard Financeiro. Tivemos um atendimento próximo e até treinamento presencial para aprender a cadastrar os imóveis. Isso nos trouxe muito mais autonomia e confiança no dia a dia da Dr. Regulariza.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "DuNorteCred",
    content:
      "A parceria com a Rio Hacks trouxe inovação para a DuNorte Cred. Além de desenvolverem nosso site e chatbot, tivemos suporte direto no nosso escritório, com treinamento para usar o sistema CRM. Isso nos deu mais agilidade no atendimento e confiança para oferecer um serviço ainda melhor aos nossos clientes.",
    categories: [1, 4],
  },
  {
    ...
    company: "LbIn",
    content:
      "A Rio Hacks entendeu nossas necessidades e entregou soluções que fizeram diferença na gestão da LB IN. O sistema de Dashboard Financeiro e o de atendimento trouxeram mais organização e agilidade, permitindo que a gente se concentre no que realmente importa: oferecer experiências únicas para nossos clientes.",
    categories: [1, 5],
  },
  {
    ...
    company: "ServeApp",
    content:
      "A Rio Hacks foi fundamental para tirar do papel a ideia da ServeApp. Eles desenvolveram nosso aplicativo com qualidade e visão de futuro, ajudando a construir a base para que possamos evoluir cada vez mais como um Super App",
    categories: [1, 2, 3],
  },
  {
    ...
    company: "Mirante",
    content:
      "A Rio Hacks conseguiu traduzir a sofisticação e inovação do Mirante Residence em nosso site de divulgação. O resultado trouxe a identidade do empreendimento para o digital, fortalecendo nossa presença e conectando ainda mais clientes ao nosso projeto",
    categories: [1, 3],
  },
  {
    ...
    company: "Correr.IA",
    content:
      "A parceria com a Rio Hacks foi essencial para estruturarmos a Correr.IA. O Dashboard Financeiro desenvolvido trouxe clareza e praticidade, permitindo que a gente foque no que mais importa: usar inteligência artificial para transformar negócios.",
    categories: [1],
  },
  {
    ...
    company: "Gui360",
    content:
      "A Rio Hacks foi essencial para transformar a ideia do GUI360 em uma plataforma robusta e funcional. Além de desenvolverem nosso sistema web com qualidade, fomos contemplados com investimento no segundo Hackatur, o que acelerou ainda mais nosso crescimento e impacto na área da saúde.",
    categories: [1, 5],
  },
];
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          <section id="depoimentos">
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Alguns dos Depoimentos sobre o Nosso Trabalho
            </h2>
          </section>
